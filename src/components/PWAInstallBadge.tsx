...
export const PWAInstallBadge: React.FC<PWAInstallBadgeProps> = ({ compact = false, iconOnly = false }) => {
      ...
      <>
        <div className="flex items-center justify-center gap-3">
          ...
          <button
            ...
            className="w-10 h-10 rounded-2xl bg-emerald-50 hover:bg-emerald-100 border border-emerald-200 text-emerald-700 flex items-center justify-center transition shadow-sm active:scale-90"
            title="Instalasi Android"
            aria-label="Instalasi Android"
          >
          ...
          <button
            ...
            className="w-10 h-10 rounded-2xl bg-slate-100 hover:bg-slate-200 border border-slate-300 text-slate-800 flex items-center justify-center transition shadow-sm active:scale-90"
            title="Instalasi iOS (iPhone / iPad)"
            aria-label="Instalasi iOS"
          >
            <Apple className="w-5 h-5" />
          </button>
        </div>

        {/* Modals remain accessible on click */}
        {showIOSModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 backdrop-blur-sm p-4 animate-in fade-in duration-200">
            <div className="w-full max-w-sm rounded-3xl bg-white border border-slate-200 p-6 shadow-2xl text-slate-800">
              ...
              <div className="space-y-3.5 text-sm text-slate-700">
                ...
                <div className="flex items-start gap-3 bg-slate-50 p-3 rounded-2xl border border-slate-100">
                  ...
                  <div className="space-y-1">
                    <p>
                      Tekan tombol <strong>Share / Bagikan</strong> di bilah navigasi bawah Safari.
                    </p>
                    <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-white border border-slate-200 text-xs font-semibold text-slate-700">
                      <Share2 className="w-3.5 h-3.5 text-indigo-600" />
                      <span>Icon Kotak Panah ke Atas</span>
                    </div>
                  </div>
                </div>
              ...
              <button
                onClick={() => setShowIOSModal(false)}
                className="w-full mt-5 py-2.5 rounded-xl bg-slate-900 text-white font-bold text-xs hover:bg-slate-800 transition"
              >
                Tutup Panduan
              </button>
            </div>
            ...
            <div className="w-full max-w-sm rounded-3xl bg-white border border-slate-200 p-6 shadow-2xl text-slate-800">
              <div className="flex items-center justify-between border-b border-slate-100 pb-3 mb-4">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <h3 className="text-base font-bold text-slate-900">Instalasi di HP Android</h3>
              ...
              <div className="space-y-3.5 text-sm text-slate-700">
                <div className="flex items-start gap-3 bg-slate-50 p-3 rounded-2xl border border-slate-100">
                  ...
                  <p>
                    Buka aplikasi di <strong>Google Chrome</strong> di smartphone Android Anda.
                  </p>
                </div>
                ...
                <div className="flex items-start gap-3 bg-slate-50 p-3 rounded-2xl border border-slate-100">
                  ...
                  <p>
                    Tekan menu <strong>titik tiga (⋮)</strong> di pojok kanan atas browser.
                  </p>
                </div>
              ...
              <button
                onClick={() => setShowAndroidModal(false)}
                className="w-full mt-5 py-2.5 rounded-xl bg-emerald-600 text-white font-bold text-xs hover:bg-emerald-700 transition shadow"
              >
                Mengerti
              </button>
            </div>
